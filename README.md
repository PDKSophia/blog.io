...
- [【KT】谈谈日常写代码中关于设计模式的一些思考](./KT技术专区/谈谈日常写代码中关于设计模式的一些思考.md)
...
- [前端渣渣对 DNS 的正确认知](./工作笔记/工作篇-前端渣渣对DNS的正确认知.md) `· hot` `[📌 update on 2019-10-23 ]`
...
- [谈谈日常写代码中关于设计模式的一些思考](./KT技术专区/谈谈日常写代码中关于设计模式的一些思考.md)
- 
### 🦉 算法
...
erek-resumes 致力于为简历差劲不懂如何制作简历的同学在线制作一份较为完美的简历。目前此项目已经废弃，已转接新项目：visResumeMook，该项目建设中，暂未开源，同时撰写配套的掘金小册，尽情期待～
...
主要用于学习 `vscode` 插件开发，[更多精彩demo看这里](https://github.com/PDKSophia/learn-vscode-extension/issues)
